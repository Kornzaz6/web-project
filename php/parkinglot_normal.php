    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
              ...
              <a class="nav-link" href="parkinglot.php">Home <span class="sr-only">(current)</span></a>
                ...
                <!-- <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                            ...
                            <a class="dropdown-item" href="history_user.php?user_id=<?php echo $_SESSION['id']; ?>">history</a> 
            ...
            <!-- <div class="form-inline my-2 my-lg-0">
                    ...
                    echo "<label>Welcome {$show_row['fullname']} User ID {$show_row['user_id']}</label>";
                    ?> 
                </div> -->
...
<script>
    function Uonclick() {
        document.getElementById("desc").onclick = redirect();
    }
    function redirect(){
        alert("If you want to booking. Please login first!");
        window.location.href='http://localhost/2yearwebprogram/project1term_with_rest_pass/php/login.php';
    }
</script>
</html>
...
while ($row = mysqli_fetch_array($Show_parklot)) {
    ...
    if ($row['status'] == 'empty') {
        echo "<td style='background-color:green;border-radius:10px;'><a id='desc' onclick='Uonclick()'>see<a></td>";
    } else {
